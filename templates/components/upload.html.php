...
<?php if (isset($DAV_FILE_PICKER_BUTTON_TEXT)): ?>
    <button type="button" id="dav_file_picker" class="btn btn-outline-primary mt-4 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto"><i class="bi bi-cloud"></i> <?php echo $DAV_FILE_PICKER_BUTTON_TEXT; ?></button>
<?php endif; ?>
